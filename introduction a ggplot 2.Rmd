...
library(sf)
library(flair)
stringency_index <- read.csv("https://raw.githubusercontent.com/MaelTheuliere/ggplot_shs/master/data/stringency_index.csv") %>% 
...
stringency_index_wgs84 %>% 
  ...
  ggplot() +
    geom_sf(aes(fill = ConfirmedDeaths*10000/pop_est)) + 

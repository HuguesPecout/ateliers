...
```{r}
class(ue)
head(ue[,c("name","pop_est","geometry")])
```
...
stringency_index_wgs84<- ue %>% 
  inner_join(stringency_index,by=c("iso_a3"="CountryCode"))
```

Ici nous sommes sur des données en volume (nombre de morts), on va devoir réaliser des ronds proportionnels.
